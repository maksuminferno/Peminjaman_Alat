<?php $__env->startSection('title', 'Kategori Alat - Sistem Peminjaman Alat'); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-outline-primary" onclick="editKategori(<?php echo e($kategori->id_kategori); ?>, '<?php echo e($kategori->nama_kategori); ?>')" data-bs-toggle="modal" data-bs-target="#editKategoriModal">
                                        <i class="fas fa-edit me-1"></i>Edit
                                    </button>
                                    <form action="<?php echo e(route('admin.deleteKategori', ['id' => $kategori->id_kategori])); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kategori ini?')">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('admin.storeKategori')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
    ...
    function editKategori(id, nama_kategori) {
        ...
        fetch(`/admin/kategori/${id}/edit`)
            ...
            .then(data => {
                ...
                document.getElementById('editKategoriForm').action = "<?php echo e(url('/admin/kategori')); ?>/" + id;
            })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Peminjaman_alatNEW\resources\views/admin/kategori.blade.php ENDPATH**/ ?>