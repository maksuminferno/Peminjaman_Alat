                            ...
                            <td>
                                <?php if($peminjaman->status == 'dipinjam' || $peminjaman->status == 'terlambat'): ?>
                                    <input type="checkbox" class="item-checkbox"
                                        data-id-peminjaman="<?php echo e($peminjaman->id_peminjaman); ?>"
    ...
    <div class="modal fade" id="confirmReturnSelectedModal" tabindex="-1" aria-labelledby="confirmReturnSelectedModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="returnSelectedForm" method="POST" action="<?php echo e(route('peminjam.storeReturn')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
